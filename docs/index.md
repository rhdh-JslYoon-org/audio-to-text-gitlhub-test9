...
!!! info
    ...
    **Source Code Repository:** [https://github.com/rhdh-JslYoon-org/audio-to-text-gitlhub-test9](https://github.com/rhdh-JslYoon-org/audio-to-text-gitlhub-test9)

    **GitOps Repository:** [https://github.com/rhdh-JslYoon-org/audio-to-text-gitlhub-test9-gitops](https://github.com/rhdh-JslYoon-org/audio-to-text-gitlhub-test9-gitops)

# **Usage**

To access the audio-to-text-gitlhub-test9 application that was deployed using the Software Template, complete the following instructions:
...
If you are interested in seeing the deployed Kubernetes resources, all resources were deployed into your chosen namespace of audio-to-text-gitlhub-test9. You can access this namespace through the web console or via your CLI.
